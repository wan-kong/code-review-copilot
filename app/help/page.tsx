    ...
    return (
        <div className="p-8">
            ...
            {sections.map((section) => (
                <Card key={section.id} className="mb-6 border-border/40">
                    <div className="p-6">
                        <div className="mb-6 flex items-center gap-3">
                            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-sidebar">
                                {section.icon}
                            </div>
                                ...
                                <div className="space-y-6">
                                    {section.steps.map((step, index) => (
                                        <div
                                            ...
                                            key={index}
                                            className="border-border/40 border-l-2 pb-6 pl-6 last:border-0 last:pb-0"
                                        >
                                                        ...
                                                        <ul className="space-y-1">
                                                            {step.details.map(
                                                                (detail) => (
                                                                    ...
                                                                    >
                                                                        <span className="mt-0.5 text-sidebar-primary">
                                                                            •
                                                                        </span>
                                                                        <span>
                                                                            {
                                ...
                                <div className="space-y-4">
                                    {section.content.map((item, index) => (
                                        <div
                                            // biome-ignore lint/suspicious/noArrayIndexKey: static content
                                            key={index}
                                            className="border-border/40 border-b pb-4 last:border-0 last:pb-0"
                                        >
